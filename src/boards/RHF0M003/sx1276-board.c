...
{
    GpioInit( &AntSwitchRxTx, RADIO_ANT_SWITCH_RXTX, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
}

void SX1276AntSwDeInit( void )
{
    GpioInit( &AntSwitchRxTx, RADIO_ANT_SWITCH_RXTX, PIN_ANALOGIC, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
}
